...
## Project Structure
    ...
    ├── testapiautocatalog_110095  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_110095`
...
2. Clone this repo and `cd testapiautocatalog_110095`
